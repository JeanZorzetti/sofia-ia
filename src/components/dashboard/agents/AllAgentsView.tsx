...
// 005-agentic-companies — view secundária "Todos os agentes" (FR-006). Move fiel do
// corpo da antiga página /dashboard/agents (folders + grid + drag-drop + diálogos),
// para que a galeria de Empresas seja o ponto de entrada principal sem regressão.
