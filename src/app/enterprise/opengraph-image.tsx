      ...
      >
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', flex: 1 }}>
            ...
            >
              Deploy dedicado, SLA garantido, SSO, auditoria completa e suporte enterprise 24/7.
            </div>
          </div>
        ...
        >
          ...
          <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.25)' }}>Segurança • Escala • Confiabilidade</span>
        </div>
      </div>
    ),
    { ...size }
