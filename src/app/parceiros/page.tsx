      ...
      <nav className="navbar-glass sticky top-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/preco" className="text-foreground-secondary hover:text-white transition-colors text-sm">Preços</Link>
            <Link href="/whitelabel" className="text-foreground-secondary hover:text-white transition-colors text-sm">White-label</Link>
            <Link href="/blog" className="text-foreground-secondary hover:text-white transition-colors text-sm">Blog</Link>
          </div>
          <Link href="/contato?type=parceiro" className="button-luxury px-5 py-2 text-sm flex items-center gap-1.5">
            Quero ser parceiro <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
      </nav>
