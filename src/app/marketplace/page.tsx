      ...
      <nav className="navbar-glass sticky top-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/marketplace" className="text-white text-sm font-medium">
              Marketplace
            </Link>
            <Link href="/preco" className="text-white/60 hover:text-white transition-colors text-sm">
              Preço
            </Link>
      ...
      <footer className="px-6 py-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-xs">
            &copy; 2026 ROI Labs. Marketplace de Templates de Orquestração IA.
          </p>
