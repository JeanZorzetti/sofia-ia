...
export const metadata: Metadata = {
  ...
  keywords: ['preço Polaris IA', 'planos Polaris IA', 'quanto custa Polaris IA', 'plataforma agentes ia preço', 'orquestração ia gratis', 'polaris pro business enterprise'],
