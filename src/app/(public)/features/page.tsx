...
export const metadata: Metadata = {
  ...
  keywords: [
    'features sofia ai',
    'funcionalidades orquestração agentes ia',
    'knowledge base rag',
    'ide multi-modelo ia',
    'inbox whatsapp ia',
  ...
  openGraph: {
    title: 'Features — Tudo que o Sofia AI oferece',
    description: 'Orquestração multi-agente, Knowledge Base RAG, IDE multi-modelo, inbox unificado e analytics. Tudo em uma plataforma.',
    type: 'website',
    locale: 'pt_BR',
  },
...
const features = [
  {
    ...
    description: 'Monte pipelines visuais onde cada agente tem um papel específico. Estratégias sequencial, paralela e consenso. Streaming SSE em tempo real por agente.',
    href: '/features/orchestrations',
    badge: 'Core',
    color: 'from-blue-500/20 to-blue-600/20 border-blue-500/30',
    highlights: [
      'Editor visual drag-and-drop',
      'Execução sequencial, paralela e consenso',
      'Streaming SSE por agente',
      'Histórico com replay de execuções',
    ],
  },
  {
    icon: Database,
    title: 'Knowledge Base com RAG',
    description: 'Vetorize documentos PDF, DOCX, CSV e TXT. Busca semântica com pgvector. Agentes com contexto real do seu negócio.',
    href: '/features/orchestrations',
    badge: 'RAG',
    color: 'from-purple-500/20 to-purple-600/20 border-purple-500/30',
    highlights: [
      'Upload drag-and-drop',
      'PDF, DOCX, CSV suportados',
  ...
  },
  {
    ...
    description: 'Teste e compare Groq, OpenAI, Anthropic e 50+ modelos lado a lado. Streaming em tempo real com métricas de custo e tokens por execução.',
    href: null,
    badge: 'Dev',
    color: 'from-emerald-500/20 to-emerald-600/20 border-emerald-500/30',
    highlights: [
      '50+ modelos via OpenRouter',
  ...
  },
  {
    ...
    description: 'WhatsApp via Evolution API, chat web e múltiplos canais em uma tela. Agentes IA respondem automaticamente com escalada inteligente para humanos.',
    href: null,
    badge: 'Canais',
    ...
    highlights: [
      ...
      'Escalada automática para humanos',
  ...
  },
  {
    ...
    description: 'Dashboard com custo por execução, tokens utilizados, taxa de sucesso e tempo médio. Histórico completo com replay de execuções anteriores.',
    href: null,
    badge: 'BI',
    color: 'from-yellow-500/20 to-yellow-600/20 border-yellow-500/30',
    highlights: [
      'Custo por execução em R$',
      'Tokens e tempo por agente',
      'Taxa de sucesso e erros',
      'Replay de execuções passadas',
    ],
  },
  {
    icon: Code2,
    title: 'Templates Prontos',
    description: '9+ templates de orquestração para Marketing, Suporte, Pesquisa, Jurídico, BI e mais. Pronto para usar em um clique.',
    href: '/templates',
    badge: 'Templates',
    color: 'from-pink-500/20 to-pink-600/20 border-pink-500/30',
    highlights: [
      '9 templates prontos',
      'Marketing, Suporte, Pesquisa',
      'Jurídico, BI, RH, Financeiro',
      'Personalizável após criação',
    ],
  },
]
    ...
    <div className="min-h-screen bg-background text-foreground">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'Features — Sofia AI',
            description: 'Todas as funcionalidades da plataforma Sofia AI de orquestração de agentes IA.',
            url: 'https://sofiaia.roilabs.com.br/features',
          }),
        }}
      />
      ...
      <section className="px-6 py-20 bg-background-secondary">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-foreground-tertiary mb-8">Grátis para sempre. Sem cartão de crédito. Primeira orquestração em 5 minutos.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
