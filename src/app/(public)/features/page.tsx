...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Features — Tudo que o Sofia AI oferece', description: 'Orquestração multi-agente, Knowledge Base RAG, IDE multi-modelo, inbox unificado e analytics. Tudo em uma plataforma.', type: 'website', locale: 'pt_BR' },
