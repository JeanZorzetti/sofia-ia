      ...
      <nav className="navbar-glass sticky top-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/en#features" className="text-white/60 hover:text-white transition-colors text-sm">
              Features
            </Link>
            <Link href="/en#pricing" className="text-white/60 hover:text-white transition-colors text-sm">
              Pricing
            </Link>
            <Link href="/marketplace" className="text-white/60 hover:text-white transition-colors text-sm">
              Templates
            </Link>
            <Link href="/blog" className="text-white/60 hover:text-white transition-colors text-sm flex items-center gap-1">
              <BookOpen className="w-3.5 h-3.5" />
              Blog
            </Link>
            <Link
              href="/"
              className="text-xs px-3 py-1 rounded-full border border-white/10 text-white/40 hover:text-white/70 hover:border-white/20 transition-all"
            >
              PT
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-12">
            <div>
              ...
              <p className="text-white/40 text-sm max-w-xs">
                Multi-agent AI orchestration platform with Knowledge Base, multi-model IDE, and
                integrated channels.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    { label: 'Documentation', href: '/documentacao' },
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    { label: 'Contact', href: 'mailto:contato@roilabs.com.br' },
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/30 text-sm">
              &copy; 2026 ROI Labs. Sofia AI — Multi-Agent AI Orchestration Platform.
            </p>
            <div className="flex gap-6 text-xs">
              <Link href="/" className="text-white/30 hover:text-white transition-colors">
                Portugues
              </Link>
              <Link href="/en" className="text-blue-400 font-medium">
                English
              </Link>
            </div>
          </div>
