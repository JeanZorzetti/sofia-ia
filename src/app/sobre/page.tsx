      ...
      <nav className="navbar-glass sticky top-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/cadastro" className="button-luxury px-4 py-2 text-sm">
              Comecar gratis
            </Link>
          </div>
        </div>
      ...
      <footer className="px-6 py-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white text-sm">Sofia AI por ROI Labs</span>
          </div>
          <div className="flex gap-6 text-sm text-white/40">
            <Link href="/blog" className="hover:text-white transition-colors">Blog</Link>
            <Link href="/docs" className="hover:text-white transition-colors">Docs</Link>
            <Link href="/beta" className="hover:text-white transition-colors">Beta</Link>
